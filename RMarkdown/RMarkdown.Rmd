...
####Output:
Create a link to [Google](www.google.com)

_____

> ##Exercise 2
Practice formatting using markdown syntax by setting up headers, making text **bold** and *italic*, embedding an image, and adding a [link](www.r-bar.ca). Think about where your image needs to be saved, and/or how to define the pathway to your image for R to locate and embed it properly.
